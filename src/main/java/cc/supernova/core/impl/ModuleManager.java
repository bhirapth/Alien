...
import cc.supernova.mod.Mod;
import cc.supernova.mod.gui.clickgui.ClickGuiScreen;
import cc.supernova.mod.modules.Module;
import cc.supernova.mod.modules.impl.client.*;
import cc.supernova.mod.modules.impl.combat.*;
import cc.supernova.mod.modules.impl.exploit.*;
import cc.supernova.mod.modules.impl.misc.*;
import cc.supernova.mod.modules.impl.movement.*;
import cc.supernova.mod.modules.impl.player.*;
import cc.supernova.mod.modules.impl.player.freelook.FreeLook;
import cc.supernova.mod.modules.impl.render.*;
import cc.supernova.mod.modules.settings.Setting;
import cc.supernova.mod.modules.settings.impl.BindSetting;
